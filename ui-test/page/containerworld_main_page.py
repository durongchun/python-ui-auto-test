...
import containerworld_main_data
import driver
        ...
        if os.path.exists(file_path):
            ...
            for line in lines:
                ...
                item_tuple = (
                    ...
                    self.summary_date, "")
                sql = PostgreSQLTool.__init__(self)
                PostgreSQLTool.write_to_db(item_tuple)

            # print(f.read())
            # from csv import reader
            # open file in read mode
            # with open(file_path, 'rb') as read_obj:
            # with io.TextIOWrapper(f, encoding='ascii') as text_file:
            #     # pass the file object to reader() to get the reader object
            #     csv_reader = reader(text_file)
